...
def _apply_ratio(ax, ratio, ctype):
    ...
    if ratio and not is_3d_type(ctype):
...
class PlotMixin:
    ...
    def _draw_graph_body(self):
        ...
        self._ensure_axes_projection(is_3d_type(ctype))  # 3D⇔2D 軸を用意
        self._clear_dynamic_resample()
        ...
        try:
            ...
            try:
                ...
                plot_series(
                    ...
                    zlabel=(self.z_combo.currentText() if is_3d_type(ctype) else ""),
                    view_init=(self._view_angles() if is_3d_type(ctype) else None),
